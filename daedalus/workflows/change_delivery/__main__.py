"""Per-workflow direct-form entrypoint for the change-delivery workflow.

Invocation:

    python3 -m workflows.change_delivery --workflow-root <path> <cmd>

This form pins the workflow module to change-delivery regardless of what the
