...
def test_compute_health_ignores_core_job_missing_when_engine_owner_is_hermes():
    health_module = load_module("hermes_relay_yoyopod_core_health_test", "adapters/yoyopod_core/health.py")
...
def test_collect_broken_watchers_filters_by_regex_and_error_text():
    health_module = load_module("hermes_relay_yoyopod_core_health_cbw", "adapters/yoyopod_core/health.py")
...
def test_disable_broken_watchers_disables_matching_jobs_and_returns_names():
    health_module = load_module("hermes_relay_yoyopod_core_health_dbw", "adapters/yoyopod_core/health.py")
    import re
...
def test_compute_core_job_status_splits_missing_disabled_and_stale():
    health_module = load_module("hermes_relay_yoyopod_core_health_cjs", "adapters/yoyopod_core/health.py")
